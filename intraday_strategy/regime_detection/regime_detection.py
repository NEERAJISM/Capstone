...
def save_regime_detected(ticker):
    ...
    logger.info(
        "Trading day time range: %s to %s",
        trading_data["datetime"].min(),
        trading_data["datetime"].max(),
    )
    logger.info(
        "Training day time range: %s to %s",
        training_data["datetime"].min(),
        training_data["datetime"].max(),
    )
